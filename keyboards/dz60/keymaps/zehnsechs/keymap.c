...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_PSCR,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  MO(1),  KC_SPC,           KC_RALT, KC_RGUI, XXXXXXX, KC_HOME,   KC_RCTL
    ),
